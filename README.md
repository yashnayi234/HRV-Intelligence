...
14. [Architecture Deep Dive](ARCHITECTURE.md)
...
> For a deep-dive into the LangGraph state machine, React SPA, and Serverless AWS pipeline, see the **[Architecture Documentation](ARCHITECTURE.md)**.
...
For step-by-step instructions on deploying the React Dashboard to AWS CloudFront and the FastAPI backend to AWS Lambda / ECS Fargate, please refer to the **[Deployment Guide](DEPLOYMENT.md)**.
